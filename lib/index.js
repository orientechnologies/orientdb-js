/*Code injected into Node module that is not supported in the browser*/
;(function(){
	var q = require('q');
	var http = require('http');
	var postFunc = function(success, error) {
	...
	var nodeFuncs = { post: postFunc };
	module.exports = require(__dirname + '/../src/orientdb-js.js').inject(q, http, nodeFuncs);
})();